...
<footer class="text-center text-lg-start bg-body-tertiary text-white" style="background-color: black">
  ...
  <section class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
    ...
    <div>
      ...
      <a href="https://www.instagram.com/foroworkers" class="me-4 text-reset">
        <i class="fab fa-instagram"></i>
      </a>
      <a href="https://www.linkedin.com/in/jonathan-castro-especialista-en-seo/" class="me-4 text-reset">
        <i class="fab fa-linkedin"></i>
      </a>
      <a href="https://github.com/foroworkers" class="me-4 text-reset">
  ...
  <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
    © 2024 Copyright:
    <a class="text-reset fw-bold" href="https://desdecerophp.blogspot.com/p/jonathan-castro-desarrollador-web.html" target="_blank">Desarrollado Por Jonathan Castro</a>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->